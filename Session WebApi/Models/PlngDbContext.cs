...
namespace Session_WebApi.Models
{
    public partial class PlngDbContext : DbContext
    {
        ...
        public virtual DbSet<Usersessioninfo> Usersessioninfo { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
               ...
               .Build();
                var connectionString = configuration.GetConnectionString("PlanningDatabase");
